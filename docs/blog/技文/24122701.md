---
title: 轮子市场：发布属于自己的 npm 包
createTime: 2025/9/10
cover: /blog-covers/npm.png
tags:
 - npm
 - Open Source
...
学会用「轮子」是第一步，下一步就是「造轮子」。使用各种前端工具、框架、UI组件库时，我们会发现这些工具、框架、UI组件库大多都托管在 `npm` 上，npm 是目前世界上最大的包管理平台，拥有海量的开源包。

如果你也想把自己写的轮子分享给大家，发布到 npm 上是一个不错的选择。本文介绍如何发布一个简单的 npm 包。
