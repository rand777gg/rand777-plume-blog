...
import { computed, type CSSProperties, onBeforeUnmount, onMounted, onUnmounted, ref, useTemplateRef, watch } from 'vue'
...
<template>
  <div class="container">
    <div
      ref="containerRef"
      class="background-container" :class="[className]"
      :style="style"
    ...
    <div class="head-social">
      ...
      <a href="mailto:hi@rand777.com" target="_blank" class="head-social-btn">
        <icon class="head-social-btn" name="ic:baseline-email" />
      </a>
      <a href="/more/academy/" class="head-social-btn">
        <icon class="head-social-btn" name="solar:square-academic-cap-outline" />
      </a>
    </div>
        ...
        <AboutMeText>
          <template #motto>
            <slot name="motto">
              ...
              <p
                class="about-me-card-text-big about-me-card-text-color" align="right"
